...
export default async function Home() {
  ...
  return (
    <div>
      <h1 className="font-semibold text-2xl mb-6">Produtos em Destaque</h1>
      <div className="grid max-h-[860px] grid-cols-9 grid-rows-6 gap-6">
        ...
        <div className="col-span-9 row-span-2 md:col-span-3 md:row-span-6 flex sm:flex-col flex-wrap gap-4" >
          {otherProducts.map(product => {
            return (
              <Link
                key={product.id}
                href={`/product/${product.slug}`}
                className="group flex-1 relative rounded-lg bg-zinc-900 overflow-hidden flex justify-center items-end"
              >
                <Image
                  src={product.image}
                  width={400}
      ...
      <div className="mt-8 w-full">
        <h2 className="font-semibold text-2xl mb-6">Todos os Produtos em Estoque</h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 w-full gap-6">
